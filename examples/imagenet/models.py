...
class ResNet(nn.Module):
  """ResNetV1."""
  def apply(self, x, num_classes, num_filters=64, num_layers=50, train=True, dtype=jnp.float32):
    ...
    for i, block_size in enumerate(block_sizes):
      for j in range(block_size):
        ...
        x = ResidualBlock(x, num_filters * 2**i, strides=strides, train=train, dtype=dtype)
